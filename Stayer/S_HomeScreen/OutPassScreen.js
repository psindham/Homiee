      ...
      <View
        ...
        <View style={{flex: 1, flexDirection: 'row'}}>
          <View style={{flex: 1, flexDirection: 'column'}}>
            <Text style={{fontSize: 20, fontColor: ''}}>
              {data.Description}
            </Text>
            <View style={{flex: 1, flexDirection: 'row'}}>
  ...
  render() {
    if (this.state.activity) {
      ...
      if (this.state.Present) {
            ...
            <View
              ...
              <TouchableOpacity
                ...
                onPress={() => { 
                  ...
                  this.props.navigation.navigate('AddOutpass');
                ...
                <Icon2
                  ...
                  color="white"
                />
                <Text style={styles.textdesign}>Book OutPASS</Text>
              </TouchableOpacity>
            </View>
        ...
        return (
          <View>
            <View style={{justifyContent: 'center', alignItems: 'center',height: '83%'}}>
              <Image
                style={{width: '100%', height: '53%'}}
                source={require('./../../images/outpass.jpg')}
              />
            </View>
            <View
              style={{
