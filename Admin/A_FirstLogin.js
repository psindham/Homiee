...
export class A_FirstLogin extends Component {
  state = {
    icon: 'eye-off',
    passwordenable: true,
    email: '',
              ...
              <View
                ...
                <Button
                  onPress={() =>
                   ...
                   //this.props.navigation.navigate('HomePage',{UserEmail:'super@gmail.com'})
                  }>
                  Login
                </Button>
                <Button
                  onPress={
                 //   () => this.props.navigation.navigate('SignupNav',{UserEmail:'super@gmail.com',})
